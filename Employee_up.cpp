...
int  main()
{
    Date today(2015, 5, 30);

    Date birth1(1969, 7, 11);
    Date birth2(1969, 8, 11);
    Date birth3(1969, 9, 11);
    Date birth4(1969, 10, 11);
    Date birth5(1969, 11, 11);
    ...
    Employee employees[5]= {Employee("Bob", "Blue",birth1,hire1),Employee("old","oldwork",birth2,hire2),Employee("Bob3", "Blue3",birth3,hire3),Employee("Bob4", "Blue4",birth4,hire4),Employee("Bob5", "Blue5",birth5,hire5)};
    Employee::getMostFaith(employees,5).print();
    cout << "已工作了" << Employee::getMostFaith(employees,5).getDaysWorked(today) << "天" << endl;
